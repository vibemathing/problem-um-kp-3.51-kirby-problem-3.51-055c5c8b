...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.51-kirby-problem-3.51-055c5c8b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.51"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.51-kirby-problem-3.51-055c5c8b-v1",
      "problem_contract_sha256": "27412927563878f8016e2e662a31a75841e34ad6f7e4798073aa27d7d1319682",
      "problem_id": "problem:um-kp-3.51-kirby-problem-3.51-055c5c8b",
      "route_id": "route:um-kp-3.51-kirby-problem-3.51-055c5c8b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.51-kirby-problem-3.51-055c5c8b-source-fidelity-01",
      "graph_id": "graph:um-kp-3.51-kirby-problem-3.51-055c5c8b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.51-kirby-problem-3.51-055c5c8b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.51-kirby-problem-3.51-055c5c8b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose Y is a rational homology 3-sphere such that every homomorphism $\\pi_1(Y)$ $\\to$ $\\operatorname{SU}(2)$ has abelian image. Does it follow that $$ \\dim_{\\mathbb{C}} I^{\\#}(Y;\\mathbb{C})=|H_1(Y;\\mathbb{Z})|, $$ i.e., that Y is an instanton L-space?"
          },
          "statement_sha256": "d4e5eff4c842d7833648acc8b393aeeb7fb3b07beaf2f570160224ea6ad8ba24"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.51-kirby-problem-3.51-055c5c8b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.51-kirby-problem-3.51-055c5c8b-root",
      "route_id": "route:um-kp-3.51-kirby-problem-3.51-055c5c8b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.51-ce51f79f1987",
        "url": "https://www.unsolvedmath.com/problems/KP-3.51"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
